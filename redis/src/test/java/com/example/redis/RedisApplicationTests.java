...
class RedisApplicationTests {
    ...
    public void putString() {
        ...
        redisTemplate.opsForValue().set("da", "zhangsan111");
    }
    ...
    public void putStringIfAbsent() {
        ...
        try {
            ...
            redisTemplate.opsForValue().set("hhhh", string);
    ...
    public void getString() {
        String name1 = (String) redisTemplate.opsForValue().get("hhhh");
        try {
            User user = objectMapper.readValue(name1, User.class);
    ...
    public void getHashObject() {
        ...
        User o = (User) redisTemplate.opsForHash().get(object, "user1");
